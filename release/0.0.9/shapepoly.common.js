...
function be(el, _a) {
  ...
  var style = getComputedStyle(sideElements[0]);
  var elStrokeWidth = strokeWidth || direction === TOP || direction === BOTTOM ? style.height : style.width;
  var elStroke = stroke || style.backgroundColor;
  var percentElement = el.querySelector("." + SIDE_CLASS + "-percent");

  var _f = css({
    strokeWidth: elStrokeWidth,
    side: side,
    split: split,
    starRadius: starRadius,
    stroke: elStroke,
...
//# sourceMappingURL=shapepoly.common.js.map
